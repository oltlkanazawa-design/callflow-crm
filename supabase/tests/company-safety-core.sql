...
insert into public.companies (id, organization_id, name, phone, website_url, location, owner_id) values
  ...
  ('c0000000-0000-0000-0000-000000000007','a0000000-0000-0000-0000-00000000000a','T18重複確認企業','070-1111-2222',null,'岡山県岡山市','a1111111-1111-1111-1111-111111111111');
...
begin
  select public.create_companies_checked(
    p_rows := $j$[
      ...
      {"name":"T18重複確認企業","phone":"","location":"岡山県岡山市"}
    ]$j$::jsonb
  ) into v_result;
...
insert into public.companies (id, organization_id, name, phone, website_url, location, memo) values
  ...
  ('c0000000-0000-0000-0000-000000000011','a0000000-0000-0000-0000-00000000000a','T20衝突先企業','080-2000-0002','https://t20-shared.example.com','テスト所在地Y','');
