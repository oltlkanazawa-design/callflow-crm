...
不明な項目は無理に埋めず、contact_nameはnull、next_action_atもnull、confidenceを低めにしてください。`;
...
「来週火曜日」等の相対的な日時表現は、現在日時を基準にISO 8601形式（例: 2026-07-28T10:00:00+09:00）へ変換してください。
日時が曖昧な場合や特定できない場合はnext_action_atをnullにしてください。発言にない日時を推測で補完しないでください。
